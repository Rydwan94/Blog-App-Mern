...
export const HomeInfoCard = ({ homeData }: HomeInfoCardProps) => {
  return (
    <Link to={`/search?searchTerm&category=${homeData.mainCategory}`}>
      <div className="mx-auto mt-32 max-w-7xl">
        ...
        >
          <div className="mb-5 flex items-center justify-between">
            <h4 className="flex items-center gap-x-2 text-xl font-extrabold">
              {homeData.mainCategory}
              <span className="animate-bounce text-2xl text-indigo-800">
